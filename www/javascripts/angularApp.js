...
app.factory('posts', ['$http', 'auth', function($http, auth){
	  ...
	  o.getAll = function() {
	    return $http.get('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/posts').success(function(data){
	      angular.copy(data, o.posts);
	    });
	  };
	  o.create = function(post) {
		  return $http.post('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/posts', post, {
    headers: {Authorization: 'Bearer '+auth.getToken()}
		...
		o.upvote = function(post) {
		  return $http.put('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/posts/' + post._id + '/upvote', null, {
    headers: {Authorization: 'Bearer '+auth.getToken()}
  })
		    .success(function(data){
		      post.upvotes += 1;
		...
		o.get = function(id) {
		  return $http.get('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/posts/' + id).then(function(res){
		    return res.data;
		  });
		};
		o.addComment = function(id, comment) {
		  return $http.post('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/posts/' + id + '/comments', comment, {
		    headers: {Authorization: 'Bearer '+auth.getToken()}
		  });
		};
		o.upvoteComment = function(post, comment) {
		  return $http.put('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/posts/' + post._id + '/comments/'+ comment._id + '/upvote', null, {
    headers: {Authorization: 'Bearer '+auth.getToken()}
  })
		    .success(function(data){
		      comment.upvotes += 1;
...
app.factory('user', ['$http', 'auth', function($http, auth){
    ...
    headers: {Authorization: 'Bearer '+auth.getToken()}
		...
		o.getAll = function() {
		  return $http.get('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/users', {
    headers: {Authorization: 'Bearer '+auth.getToken()}
  }).then(function(res){
		    return res.data;
		  });
		...
		o.get = function(id) {
		  return $http.get('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/users/' + id).then(function(res){
		    return res.data;
		  });
		};
		
		o.update = function(user){
	  return $http.put('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/users/' + user._id, user, {
    headers: {Authorization: 'Bearer '+auth.getToken()}
  }).success(function(data){
	    return data
	  });
...
app.factory('auth', ['$http', '$window', function($http, $window){
   ...
   auth.saveToken = function (token){
	...
	auth.register = function(user){
	  return $http.post('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/register', user).success(function(data){
	    auth.saveToken(data.token);
	  });
	};

	auth.logIn = function(user){
	  return $http.post('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/login', user).success(function(data){
	    auth.saveToken(data.token);
	  });
	};
...
app.factory('unit', ['$http', 'auth','$window', function($http, auth, $window){
   ...
   o.getAll = function(id) {
	    return $http.get('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/users/'+ id +'/units').success(function(data){
	      return data;
	    });
	  };
   o.get = function(userId,id) {
		  return $http.get('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/users/'+ userId +'/units/'+ id).then(function(res){
		    return res.data;
		  });
		};
   
	o.create = function(unit, id){
	  return $http.post('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/users/'+ id +'/units', unit, {
    headers: {Authorization: 'Bearer '+auth.getToken()}
  }).success(function(data){
		    return data;
		  });
	...
	o.update = function(unit, id, unitData){
	  return $http.put('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/users/'+ id +'/units/'+ unit, unitData, {
    headers: {Authorization: 'Bearer '+auth.getToken()}
  }).success(function(data){
	    return data
	  });
	...
	o.deleteUnit = function(unitId, userId){
	  return $http.delete('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/users/'+ userId +'/units/'+ unitId, {
    headers: {Authorization: 'Bearer '+auth.getToken()}
  }).success(function(data){
		    return unitId;
		  });
...
app.factory('methods', ['$http', 'auth', function($http, auth){
	  ...
	  o.get = function() {
	    return $http.get('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/admin/methods/').success(function(data){
	      return data;
	    });
	  };
	  o.create = function(method) {
		  return $http.post('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/admin/methods', method, {
    headers: {Authorization: 'Bearer '+auth.getToken()}
  }).success(function(data){
		    return data;
		  });
		...
		o.update = function(method) {
		  return $http.put('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/admin/methods', method, {
    headers: {Authorization: 'Bearer '+auth.getToken()}
  }).success(function(data){
		    return data;
		  });
...
app.factory('roya', ['$http', 'auth', function($http, auth){
	  ...
	  o.getAll = function() {
	    return $http.get('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/roya').success(function(data){
	      return data;
	    });
	  };
	  o.create = function(roya) {
		 return $http.post('http://ec2-54-68-110-187.us-west-2.compute.amazonaws.com/roya', roya, {
    headers: {Authorization: 'Bearer '+auth.getToken()}
  }).success(function(data){
		    return data;	
		  });
